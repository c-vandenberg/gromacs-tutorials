...
## 1.2 Simulation Commands

### 1.2.1 Cleaning the Input Structure
...
### 1.2.3 Defining the Simulation Box
...
### 1.2.4 Solvating the Simulation Box with Water
...
### 1.2.5 Adding Ions to the Solvated System
